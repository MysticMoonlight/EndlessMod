...
- <del>[**Edge**](https://github.com/MysticMoonlight/EndlessMod/blob/main/editions/edge.md) is the Forge based modpack. It is based on LTS version of Minecraft Forge, to comply with their [support policy](https://forums.minecraftforge.net/topic/91712-supported-version-directory/). It has many mods compared with Libre edition. Edge version will no longer be supported after 1.18 release.</del>
